...
@media(max-width:900px){.lgs-editor.gs-editor-v2 .gs-command-bar{grid-template-columns:1fr auto}.lgs-editor.gs-editor-v2 .gs-command-center{display:none}.lgs-editor.gs-editor-v2 .gs-hide-mobile{display:none}.lgs-editor.gs-editor-v2 .workspace{height:calc(100vh - var(--gs-bar-h) - 56px)}}
` + PRODUCTION_REVIEW_CSS;
